                ...
                <section>
                    ...
                    <div className="space-y-4">
                        {publicCompetitions.map((comp) => (
                            <Link key={comp.id} href={`/competitions/${comp.id}`} className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-gray-200 dark:border-slate-800 flex items-center justify-between hover:border-blue-500 dark:hover:border-violet-500 transition-all group">
